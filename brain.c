...
typedef enum { NOP = 0, TURNL, TURNR, STEP, ROCKET, RADAR, BOMB, 
				SET, CPY, 
				ADD, ADDR, SUB, SUBR, 
				JMP, JMPZ, JMPNZ, DJMPZ, DJMPNZ, RET, 
				INV, NEG, AND, ANDR, OR, ORR, SSTEP, RND } OpCodes;
...
struct {
	...
	{iname : "turnl",	oc : TURNL,},
	{iname : "turnr",	oc : TURNR,},
	{iname : "step",	oc : STEP,},
	{iname : "rocket",	oc : ROCKET,},
	{iname : "radar",	oc : RADAR,},
	{iname : "bomb",	oc : BOMB,},
	...
	{iname : "sstep ",	oc : SSTEP,},
	{iname : "rnd ",	oc : RND,},
};

typedef enum { EI_WALL=0, EI_ROCKET=1, EI_ROBOT=2, EI_STEP=3 } EventIndex;
...
int compile(char *fname)
{
	...
	while (fgets(tl, 4096, fp) != NULL)
	{
		...
		if ((l = index(tl, '#')) != NULL) *l = 0;
		if ((l = index(tl, '\n')) != NULL) *l = 0;
		if ((l = index(tl, '\r')) != NULL) *l = 0;
